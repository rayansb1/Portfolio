...
function App() {
  ...
  const contentList = [
    ...
    "Proficient in a diverse range of programming languages including (HTML/CSS, JavaScript, PHP, Java, dart) I specialize in frontend development using (React, Flutter) frameworks. Skilled in MySQL databases, I also have extensive experience with version control systems such as Git and GitHub.",
    "•1 Invoice Uploader Power App: Revolutionizing invoice handling by seamlessly uploading and organizing invoices across branches, enhancing administrative efficiency. •2 Amnoon Invoice Management: A robust web application for efficient invoice collection and processing, ensuring accurate financial records management. •3 Amnoon Website: The Amnoon Website enhances user interaction and streamlines business operations with its dynamic platform and responsive design."
  ];
